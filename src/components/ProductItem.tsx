...
const ProductItem: React.FC<ProductItemProps> = ({ img, name, rating, features, normalPrice, discountedPrice }) => {
  return (
    <div
      className="product-item border border-gray-200 rounded p-4 mb-4 transition-shadow duration-300 hover:shadow-lg flex flex-col items-center text-center bg-white"
    >
      <a href="./pdp.html">
